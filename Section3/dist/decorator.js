...
function FieldMetadata(metadataValue) {
...
function BookDecorator(value, context) {
    const metadata = context.metadata[metadataKey];
    console.log("Book metadata:");
    console.log(metadata);
}
let Book = (() => {
    let _classDecorators = [BookDecorator];
    ...
    var Book = class {
        ...
        static {
            ...
            _title_decorators = [FieldMetadata("The Great Gatsby")];
            _author_decorators = [FieldMetadata("F. Scott Fitzgerald")];
        ...
        title = __runInitializers(this, _title_initializers, "The Great Gatsby");
        author = (__runInitializers(this, _title_extraInitializers), __runInitializers(this, _author_initializers, "F. Scott Fitzgerald"));
        constructor() {
